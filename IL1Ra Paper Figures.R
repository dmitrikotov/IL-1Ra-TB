...
#Fig. 2b - tb.counts.norm, TB.infected and strict genotype signatures generated in Mouse to Human Signatures Clean.R; berry.southafrica.tb and berry.southafrica.norm are from Human TB Signatures_clean.R
...
#Sup. Fig. 2b - counts.GSE42834 and meta.42834 are from TB vs Ohter Disesases Gene Sig_clean.R
counts.GSE42834 <- readRDS(file = "/Users/dmitrikotov/Library/CloudStorage/Box-Box/Dmitri Personal/DK Postdoc Data and Analysis/Coding stuff/TB vs Other Diseases Gene Sig/counts_GSE42834")
meta.42834 <- readRDS(file = "/Users/dmitrikotov/Library/CloudStorage/Box-Box/Dmitri Personal/DK Postdoc Data and Analysis/Coding stuff/TB vs Other Diseases Gene Sig/meta_GSE42834")
B6.strict <- read.csv(file = "/Users/dmitrikotov/Library/CloudStorage/Box-Box/Coding stuff/Irg1 and iNOS scRNAseq 220315/B6 Strict Genes.csv") %>% filter(change == "up")
Sp140.strict <- read.csv(file = "/Users/dmitrikotov/Library/CloudStorage/Box-Box/Coding stuff/Irg1 and iNOS scRNAseq 220315/Sp140 Strict Genes.csv") %>% filter(change == "up")
Irg1.strict <- read.csv(file = "/Users/dmitrikotov/Library/CloudStorage/Box-Box/Coding stuff/Irg1 and iNOS scRNAseq 220315/Irg1 Strict Genes.csv") %>% filter(change == "up")
iNOS.strict <- read.csv(file = "/Users/dmitrikotov/Library/CloudStorage/Box-Box/Coding stuff/Irg1 and iNOS scRNAseq 220315/iNOS Strict Genes.csv") %>% filter(change == "up")
...
pneumonia.b6.roc <- roc(human.disease.42834$status, human.disease.42834$sig1, levels = c("TB","Pneumonia"))
pneumonia.sp140.roc <- roc(human.disease.42834$status, human.disease.42834$sig2, levels = c("TB","Pneumonia"))
pneumonia.irg1.roc <- roc(human.disease.42834$status, human.disease.42834$sig3, levels = c("TB","Pneumonia"))
pneumonia.inos.roc <- roc(human.disease.42834$status, human.disease.42834$sig4, levels = c("TB","Pneumonia"))
plot(pneumonia.b6.roc, print.auc = TRUE, col = "red", print.auc.y =0.47)
plot(pneumonia.sp140.roc, add=TRUE, print.auc = TRUE, col = "blue",  print.auc.y =0.4)
plot(pneumonia.irg1.roc,add = TRUE, print.auc = TRUE, col = "chartreuse", print.auc.y =0.33)
plot(pneumonia.inos.roc, add=TRUE, print.auc = TRUE, col = "cadetblue2",  print.auc.y =0.27)

cancer.b6.roc <- roc(human.disease.42834$status, human.disease.42834$sig1, levels = c("TB","Cancer"))
cancer.sp140.roc <- roc(human.disease.42834$status, human.disease.42834$sig2, levels = c("TB","Cancer"))
cancer.irg1.roc <- roc(human.disease.42834$status, human.disease.42834$sig3, levels = c("TB","Cancer"))
cancer.inos.roc <- roc(human.disease.42834$status, human.disease.42834$sig4, levels = c("TB","Cancer"))
plot(cancer.b6.roc, print.auc = TRUE, col = "red", print.auc.y =0.47)
plot(cancer.sp140.roc, add=TRUE, print.auc = TRUE, col = "blue",  print.auc.y =0.4)
plot(cancer.irg1.roc,add = TRUE, print.auc = TRUE, col = "chartreuse", print.auc.y =0.33)
plot(cancer.inos.roc, add=TRUE, print.auc = TRUE, col = "cadetblue2",  print.auc.y =0.27)
...
#Supp. Fig. 5e - ACS.progressors is from ACS Cohort Analysis.R
ACS.progressors <- readRDS(file = '/Users/dmitrikotov/Library/CloudStorage/Box-Box/Dmitri Personal/DK Postdoc Data and Analysis/Coding stuff/ACS Cohort/ACS_progressors')

IL1RN.progressors <- plotCounts(ACS.progressors, gene="IL1RN", intgroup="TimeToTB", returnData=T)
