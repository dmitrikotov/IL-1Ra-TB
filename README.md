...
File descriptions:
Mouse Signature ML Feature selection.R - Using the caret package for machine learning feature selection to generate new mouse signatures and then test their ability to discern human disease.
